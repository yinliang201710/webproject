...
const init = () => {
  ...
  const fieldTemplate = toFieldTemplate($, go)
  // This template represents a whole "record".
  myDiagram.nodeTemplate = toNodeTemplate($, go, fieldTemplate)

  myDiagram.linkTemplate = toLinkTemplate($, go)
...
const toNodeTemplate = ($, go, fieldTemplate) => {
  return $(
    go.Node,
    'Auto',
